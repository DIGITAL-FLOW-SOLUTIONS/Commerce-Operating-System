          ...
          <EmptyState
            ...
            action={
              <Link href={`${base}/products`}>
                <button className="bg-primary text-primary-foreground font-semibold px-6 py-2.5 rounded-xl text-sm">
                  Browse Products
                </button>
              </Link>
            }
              ...
              {items.map((item) => (
                ...
                >
                  <div className="w-16 h-16 rounded-xl overflow-hidden shrink-0">
                    <ProductImage imageUrl={item.imageUrl} name={item.productName} size="md" />
                  </div>
        ...
        <div className="fixed bottom-0 left-0 right-0 bg-background/95 backdrop-blur-sm border-t border-border p-4">
          <div className="max-w-lg mx-auto">
            ...
            <motion.button
              ...
              className="w-full py-4 rounded-xl font-display font-bold bg-primary text-primary-foreground shadow-sm hover:opacity-90 transition-opacity"
            >
